...
COLLECTUSER=$(ssh root@$CHECKDOMAINIP -p22022 grep -w $DOMAIN /etc/trueuserdomains | awk '{print $2}')
#COLLECT HOSTNAME
COLLECTHOSTNAME=$(ssh root@$CHECKDOMAINIP -p22022 uname -n)
